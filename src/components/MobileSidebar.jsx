    ...
    <header className="lg:hidden md:hidden flex justify-between my-4 relative">
      ...
      {isOpen && (
        <div className="bg-[#DBECDB] text-[rgb(15,22,15)] p-8 py-12 h-[100vh] w-[100%] absolute top-20 left-0 bg-baseBlack/70 z-50">
          ...
          <p className="lg:text-[14px] md:text-[14px] text-[14px] text-[#0F160F] items-center py-2  px-6  hover:text-[#015C28] font-bold">Wallet Address:</p>
          <p className="lg:text-[14px] md:text-[14px] text-[14px] text-[#015C28] items-center py-2  px-6  hover:text-[#015C28]">0xf768912a201645nnq710</p>
          <p className="lg:text-[14px] md:text-[14px] text-[14px] text-[#0F160F] items-center py-2 px-6  hover:text-[#015C28] font-bold">You currently have:</p>
          <p className="lg:text-[14px] md:text-[14px] text-[14px] text-[#015C28] items-center py-2  px-6  hover:text-[#015C28] ">20 GR points</p>
        </div>
      )}
    </header>
  );
