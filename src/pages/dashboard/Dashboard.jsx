    ...
    <main className="bg-white">
      <div className='flex flex-col lg:flex-row md:flex-row bg-[#263E59] rounded-[20px] w-[100%] text-white'>
        <div className='lg:w-[60%] md:w-[60%] w-[100%] p-8'>
          ...
          <div className='mt-6'>
            <button onClick={() => navigate('/dashboard/createprofile')} className="bg-white text-[#154A80] py-2 px-4 rounded-lg lg:text-[20px] md:text-[20px] font-bold text-[16px] lg:w-[50%] md:w-[50%] w-[100%] my-2 hover:bg-[#263E59] hover:font-bold">Create Profile</button>
          </div>
        </div>
